<template>
     <div class="flex sm:items-center justify-between px-4 sm:px-0 py-3 border-b-2 border-gray-200 dark:border-gray-500">
                    <div class="relative flex items-center space-x-4">
                        ...
                        <div class="flex flex-col leading-tight">
                            ...
                            <span class="text-gray-700 mr-3 dark:text-gray-300">Anderson Vanhron</span>
                            </div>
                            <span class="text-lg text-gray-600 dark:text-gray-400">Junior Developer</span>
                        </div>
                    </div>
